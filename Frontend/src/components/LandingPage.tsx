          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <SignedIn>
              ...
              <button 
                ...
                className="bg-primary text-primary-foreground px-8 py-4 rounded-lg text-lg font-semibold hover:opacity-90 transition-all transform hover:scale-105"
              >
                Go to Dashboard
              </button>
            </SignedIn>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-primary">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <SignedIn>
            ...
            <button 
              onClick={goToDashboard}
              className="bg-background text-foreground px-8 py-4 rounded-lg text-lg font-semibold hover:bg-card transition-all transform hover:scale-105"
            >
              Go to Dashboard
            </button>
          </SignedIn>
          ...
          <SignedOut>
            {/* Not logged in state - show signup button */}
            <SignUpButton mode="modal">
